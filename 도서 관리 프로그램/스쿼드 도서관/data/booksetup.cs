...
{
    public partial class booksetup : UserControl
    {
        public booksetup()
        {
            InitializeComponent();
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            if (comboBox7.Text == "글쓴이")  // if문으로 콤보박스 중 하나의 키워드를 적는다
            {
                try
                {
                    MySqlConnection connection = new MySqlConnection("datasource=localhost;port=3306;username=root;password=qkrwltn5130!; Convert zero Datetime = true");  //DB 주소 가져오기
        ...
        {
            MySqlConnection conn = new MySqlConnection("datasource = localhost; port = 3306; username = root; password=qkrwltn5130!; Convert Zero Datetime = true");
            //MySqlDataReader Rd;
            conn.Open();
...
+ "values('" + textBox17.Text + "','" + textBox1.Text + "','" + comboBox3.Text + "','" + comboBox2.Text + "','" + textBox4.Text + "','" + textBox3.Text + "','" + textBox7.Text + "','" + textBox8.Text + "','" + textBox13.Text + "','" + textBox14.Text + "','" + textBox5.Text + "','" + textBox16.Text + "','" + comboBox4.Text + "','" + comboBox5.Text + "','" + textBox10.Text + "','" + textBox9.Text + "','" + textBox15.Text + "');";
        ...
        void UPDATEUser1() //대출 가능 권수 = 0 일때 회원 상태 대출 불가로 변경 해줘야 함
        {
            if (textBox4.Text == "0")
            {
                MySqlConnection con = new MySqlConnection("datasource = localhost; port = 3306; username = root; password=qkrwltn5130!");
